...
public class HudDrawContextImpl implements IHudDrawContext {
    ...
    public void drawSprite(
        ...
        graphics.blitSprite(toId(sprite), x, y, w, h);
    }
    ...
    public void drawSpriteRegion(
        ...
        graphics.blitSprite(toId(sprite), texW, texH, u, v, x, y, w, h);
    }
    ...
    private static ResourceLocation toId(@NonNull HudSprite sprite) {
        return ResourceLocation.fromNamespaceAndPath(sprite.namespace(), sprite.path());
    }
