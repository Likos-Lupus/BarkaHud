...
dependencies {
    ...
    modImplementation("net.fabricmc:fabric-loader:$depsFabricLoader")
    modImplementation("net.fabricmc.fabric-api:fabric-api:$depsFabricApi")
    modImplementation("com.terraformersmc:modmenu:$depsModmenu")
    modImplementation("dev.isxander:yet-another-config-lib:$depsYacl")
