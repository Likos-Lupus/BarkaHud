...
public class HudData {
    ...
    /**
     * Updates the data. Assumes player is in a boat. Do not call unless you are absolutely sure the player is in a
     * boat.
     */
    public void update() {
        ...
        // a̅•b̅ = |a̅||b̅|cos ϑ
        // ϑ = acos [(a̅•b̅) / (|a̅||b̅|)]
        this.driftAngle = Math.toDegrees(Math.acos(velocity.dot(boat.getLookAngle()) / velocity.length() * boat.getLookAngle()
                .length()));
